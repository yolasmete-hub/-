...
?>
<<?php echo $moduleTag; ?> class="wfp-card <?php echo $moduleClass; ?>">
	<?php if ($module->showtitle) : ?>
		<<?php echo $headerTag; ?> class="wfp-card-title <?php echo $headerClass; ?>"><span><?php echo $module->title; ?></span></<?php echo $headerTag; ?>>
	<?php endif; ?>
